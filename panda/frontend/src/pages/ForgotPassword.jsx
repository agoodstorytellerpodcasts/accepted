        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-100">
          {message ? (
            <div className="text-center">
              <div className="bg-green-50 border-l-4 border-brand-green p-4 text-sm text-green-700 mb-6 text-left">
                {message}
              </div>
              <Link to="/login" className="font-bold text-brand-slate hover:text-brand-green transition-colors">
                Back to login
              </Link>
            </div>
          ) : (
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="text-center">
                <Link to="/login" className="text-sm font-medium text-slate-600 hover:text-brand-green">
                  Back to login
                </Link>
              </div>
            </form>
